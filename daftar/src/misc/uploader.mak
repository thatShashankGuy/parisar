...
aws logs get-log-events --log-group-name /aws/lambda/parisar-backend-ParisarWebBackend-93FHfpQbquns --log-stream-name fcc46adcb1f2447fa705661c7d5048

aws s3api put-object --bucket thatshashankguy-storage-bucket --key blogs/

 INSERT INTO vartalaap_Table(serialNo,title,episodeId)
VALUES ("vartalaap05","Little bit about interviewing","#5"),
